...
class BmdEmailFromSubscriptionService extends Client
{
    ...
    // http://api2.bm-data.com/services/bm400/1.3/ContactAPI.asmx/GetSubscriptionListFromEmail?db=x&email=charlottebluckert@hotmail.com&serviceID=BP_CCI
    ...
    public function subscriptionIdFromEmail($email)
    {
        ...
        return $xml_response->Subscription[0]->SubscriptionNr;
    }
}